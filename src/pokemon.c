...
// Note: Hoenn dex has been removed - only National dex is used.

// (sHoennToNationalOrder table removed - no longer needed)
...
// NationalToHoennOrder removed - no longer needed
...
// SpeciesToHoennPokedexNum removed - no longer needed

// HoennToNationalOrder removed - no longer needed
...
{
    return SpeciesToNationalPokedexNum(species) != NATIONAL_DEX_NONE;
}
